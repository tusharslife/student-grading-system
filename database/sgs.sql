...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2671979569ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sgs&table=abc">`sgs`.`abc`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sgs&table=abc2">`sgs`.`abc2`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sgs&table=assignment">`sgs`.`assignment`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sgs&table=exam">`sgs`.`exam`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sgs&table=feedback">`sgs`.`feedback`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sgs&table=internal1">`sgs`.`internal1`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sgs&table=internal2">`sgs`.`internal2`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sgs&table=login">`sgs`.`login`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sgs&table=teacherlist">`sgs`.`teacherlist`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sgs&table=studentlist">`sgs`.`studentlist`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="3a3021742229233e4461343356417973">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `abc`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sgs" targettable="login">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `login`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="sgs" targettable="studentlist">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `studentlist`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sgs" targettable="studentlist">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `studentlist`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="sgs" targettable="teacherlist">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `teacherlist`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sgs" targettable="login">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `login`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="sgs" targettable="internal2">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `internal2`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sgs" targettable="internal1">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `internal1`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sgs" targettable="feedback">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `exam`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sgs" targettable="assignment">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `assignment`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sgs" targettable="abc2">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `abc2`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sgs" targettable="abc">
                            <div class="action_content">
