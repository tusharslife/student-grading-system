        ...
        <div class="content">
        	...
        	<table >
        		...
        		<tr>
        			...
        			<td class="table_td"><?php echo "<a class='btn' onClick=\"javascript:return confirm('Are You Sure to Delete this')\" href='delete_teacher.php?teacher_id={$info['id']}'> Delete </a>"; ?></td>
					<td class="table_td"><?php echo "<a class='btn' href='update_teacher.php?teacher_id={$info['id']}'>Update</a>"; ?></td>
        		</tr>
        		<?php
        			}
        		?>
